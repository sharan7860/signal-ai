  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, oklch(0.85 0.14 188 / 0.55), transparent 65%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, oklch(0.7 0.22 280 / 0.5), transparent 65%)",
        }}
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, oklch(0.78 0.18 175 / 0.45), transparent 65%)",
        }}
