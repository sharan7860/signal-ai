...
const heroChartData = [
  42, 45, 41, 48, 52, 49, 56, 54, 60, 58, 65, 63, 70, 68, 76, 72, 80, 78, 85, 90,
];
  ...
  return (
    <section ref={ref} className="relative min-h-screen overflow-hidden pt-32">
      ...
      <motion.div
        ...
        style={{
          y,
          maskImage: "radial-gradient(ellipse 80% 50% at 50% 30%, black, transparent 70%)",
        }}
      />
      ...
      >
        <div className="lg:col-span-7">
          ...
          >
            ...
            <span className="text-foreground/85">Stock research workspace</span>
            <span className="text-muted-foreground/60">·</span>
            <span className="flex items-center gap-1 text-electric">
              <Sparkles className="h-3 w-3" /> Market tools
            </span>
          </motion.div>
            ...
            <span className="relative">
              ...
              <motion.span
                ...
                style={{
                  ...
                  boxShadow: "0 0 20px oklch(0.85 0.14 188 / 0.7)",
                }}
          ...
          >
            ...
            <Metric label="Research assistant">AI</Metric>
          </motion.div>
        </div>
        ...
        >
          <div className="relative">
            ...
            >
              <div className="text-xs text-muted-foreground">Explore stocks</div>
            ...
            >
              ...
              <div className="font-display text-lg font-semibold text-electric">RSI · MACD</div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div className="font-display text-lg font-semibold text-foreground">Ask & learn</div>
            </motion.div>
          </div>
        </motion.div>
      </motion.div>
