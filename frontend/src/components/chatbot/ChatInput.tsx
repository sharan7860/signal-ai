      ...
      <input
        ...
        placeholder={
          disabled
            ...
            : "Ask about stocks, trends, or portfolio strategy..."
        }
        className="min-h-[46px] min-w-0 flex-1 rounded-3xl border border-[rgba(102,252,241,0.18)] bg-slate-950/80 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-500 outline-none transition focus:border-cyan-300 focus:ring-2 focus:ring-cyan-300/20 disabled:cursor-not-allowed disabled:opacity-80"
      />
      <button
        type="submit"
